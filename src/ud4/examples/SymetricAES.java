...
public class SymetricAES {
    ...
    public static String crypt(SecretKey key, String str){
        try {
    ...
    public static byte[] crypt(SecretKey key, byte[] data) throws Exception {
    ...
    public static void main(String[] args) {
        ...
        for (SecretKey key : keys) {
            ...
            String encrypted = crypt(key, message);
